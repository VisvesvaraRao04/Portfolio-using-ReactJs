...
const Projects = () => {
  ...
  <h1 className='Headings'>Projects</h1>
        ...
        <h1 id="project_title">Image Caption Generaton by using deep learning</h1>
        ...
        <h4 id="keys"><span className="goldcolorspan">Technologys used : </span>ResNet,Inception(for extracting futures), RNN and LSTM(for genarating captions)</h4>
        <h5 id="link details"><span className="goldcolorspan">Drive link : </span><a href="https://drive.google.com/drive/folders/1MTnANKfgQ0nnbjhgCkAbG8YyCnzbIeVt?usp=sharing">Clike here to get link</a></h5>
    </div>
    <div id="project2_container" className="projects">
        ...
        <h4 id="keys"><span className="goldcolorspan">Technologys used : </span>HTML,css,Java Script</h4>
        <h5 id="link details"><span className="goldcolorspan">Website link : </span><a href="https://visvesvararao04.github.io/Restaurent/" target="_blank">Clike here to get link</a></h5>
    </div>
    <div id="project3_container" className="projects">
        ...
        <h4 id="keys"><span className="goldcolorspan">Technologys used : </span>Java,jdbc</h4>
    </div>
      </div>
  </>
}
